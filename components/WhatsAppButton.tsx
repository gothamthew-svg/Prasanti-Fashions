...
const WHATSAPP_NUMBER = '12125550100'; // Replace with actual number (country code + number, no +)
...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {showTooltip && (
        <div className="bg-white border border-gray-100 shadow-lg rounded-lg px-4 py-3 text-sm font-sans text-gray-700 max-w-[180px] text-center animate-fade-in">
